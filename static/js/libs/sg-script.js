...
(function () {
  ...
  const tabPane = document.querySelector('.sg-content .tab-pane')


  viewAll.addEventListener("click", function(e) {
    e.preventDefault()
    tabPane.classList.toggle('show-all')
...
(function () {
  ...
  const sideBarNav = document.querySelector('.sg-sidebar-nav .nav-link:not(.view-all-tabs)')
  const sideBarNavLink = document.querySelector('.sg-sidebar-nav .nav-link.show')
  const tabPane = document.querySelector('.sg-content .tab-pane')
  const viewAll = document.querySelector('.view-all-tabs')

  sideBarNav.addEventListener("click", function(e) {
    e.preventDefault()
    sideBarNavLink.classList.remove('active', 'show')
